...
- AUDIT-2 baseline/remediation: PR #97, #98, #100, and the current PR's second coverage/critical-path/maintainability controls.
...
2. **AUDIT-6 `REPO_CI_READY`:** frontend inventory, route protection, loading/error/empty states, accessibility, dan responsive baseline.
